...
function confirmacao(id) {
     ...
     if (resposta == true) {
          window.location.href = "../excluir_cadastros/excluirCrescimento.php?cod_cresc="+id;
    ...
    <section class="box">
      ...
      <div class="box-content">
      	...
      	<br>	<br>
				...
				<a class="btn btn-primary" href="../editar_cadastros/html/editaCrescimento.php?cod_cresc=<?php echo("$cod_cresc"); ?>"  style="background-color: rgba(30, 100, 200, 0.8); color: white; border-radius: 2px; cursor: pointer; padding: 6px; text-decoration: none; border-radius: 3px; margin-left: 6px; justify-content: center;"role="button">Editar</a>
